...
export default function Alex(){
    return(
        ...
        <ul><Link to="/areweserious">If you HAD to be a Buffy character, who would you be?</Link></ul>
        <ul><Link to="/eggggiiies">Which eggie dish are you?</Link></ul>
        <ul><Link to="/eggggiiies">I bet I can guess your dance style in a few short questions!</Link></ul>
        </ul>
